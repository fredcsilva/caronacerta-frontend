...
@Component({
  ...
  templateUrl: './cadastro-complementar-dados-pessoais.html',
  styleUrls: ['./cadastro-complementar-dados-pessoais.css']
})
export class CadastroComplementarDadosPessoaisComponent implements OnInit {
