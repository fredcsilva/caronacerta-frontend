...
@Component({
  ...
  templateUrl: './cadastro-complementar-condominio.html',
  styleUrls: ['./cadastro-complementar-condominio.css']
})
export class CadastroComplementarCondominioComponent implements OnInit {
